...
func CreateInitialNode(doc string) (*Node) {
...
func ApplyNewTransformation(sourceNode *Node, args *FxnArgs, region0 string) (targetNode *Node, edge *Edge) {
	// Create metadata, todo
	var date, author string
	...
	targetNode.edgesIn = append(targetNode.edgesIn, edge)
